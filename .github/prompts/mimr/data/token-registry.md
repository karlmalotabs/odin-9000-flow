...
| Short Name          | Token Studio Path           | Type                      | Native Variable Name            | Description                                                        |
| ------------------- | --------------------------- | ------------------------- | ------------------------------- | ------------------------------------------------------------------ |
| `fds-success-shade` | `var.fds.fds-success-shade` | `color` (linear-gradient) | _(paint style — `fillStyleId`)_ | Gradient stops: `ref/system/success/50` + `ref/system/success/60`. |
| `fds-info-shade`    | `var.fds.fds-info-shade`    | `color` (linear-gradient) | _(paint style — `fillStyleId`)_ | Gradient stops: `ref/system/info/50` + `ref/system/info/60`.       |
| `fds-alert-shade`   | `var.fds.fds-alert-shade`   | `color` (linear-gradient) | _(paint style — `fillStyleId`)_ | Gradient stops: `ref/system/alert/50` + `ref/system/alert/60`.     |
| `fds-error-shade`   | `var.fds.fds-error-shade`   | `color` (linear-gradient) | _(paint style — `fillStyleId`)_ | Gradient stops: `ref/system/error/50` + `ref/system/error/60`.     |
